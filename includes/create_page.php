<?php
  	/**
	 * A function to programmatically create a post/page using slug and title. 
	 *
	 * @returns -1 if the post was never created, -2 if a post with the same title exists, or the ID
	 *          of the post if successful.
	 */ 
	function evntgen_programmatically_create_page($title,$slug,$page_content,$post_type='page') {
		global $wpdb;
