...
<div class="wrapper">
  <div class="wrap" style="float:left; width:100%;">
    ...
    <div style="width:70%;float:left;"><h2>Wordpress Event Booking Manager Pro</h2></div>
       <div class="main_div">
        <div class="metabox-holder" style="width:98%; float:left;">
            <div id="namediv" class="stuffbox" style="width:60%;min-height:450px;">
              <h3 class="top_bar">More Features Available in Our Pro Version(<b>Coming Very Soon</b>):-</h3>
              <div style="padding-top:15px;margin-left:20px;">
                <a class="btnprover" target="_blank" href="http://upscalethought.com/?page_id=9" style="width:100px;height: 20px;background-color: green;color:white;" >Wordpress Event Booking Manager Pro</a>
              </div>  
                 ...
                 <div style="margin: 20px;">
                    <ol>
                      ...
                      <li>
                        <ul>
                          <li>Email Support</li>
                          <li>(i) Booker receives an email</li>
                          <li>(ii) Owner (admin) receives email of booking</li>
                        </ul>
                      </li>
                      <li>Event Calendar month, week and day view</li>
                      <li>Full Technical Support From Us and more...</li>
                    </ol>
