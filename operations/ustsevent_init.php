<?php
function evntgen_ustsevent_install() {
	global $table_prefix, $wpdb;
  $table_name1 = $table_prefix.'evntgen_ustsevents';
  $sql_sfe = "CREATE TABLE IF NOT EXISTS ".$table_name1." (
                ...
                `billing_address1` varchar(256) DEFAULT NULL,
                `billing_address2` varchar(256) DEFAULT NULL,
                ...
                `billing_phone` varchar(256) DEFAULT NULL,
                `event_id` int(11) DEFAULT NULL,
                `startdate` date DEFAULT NULL,
                `starttime` varchar(255) DEFAULT NULL,
                `enddate` date DEFAULT NULL,
                `endtime` varchar(255) DEFAULT NULL,
                `noof_ticket` int(11) DEFAULT NULL,
   ...
   $wpdb->query($sql_sfe);
	 //-------------------------------
	 $table_name2 = $table_prefix.'evntgen_ustsevents_paymentmethods';
   ...
   $wpdb->query($sql_scpm);
	 ...
	 $pm_count = $wpdb->get_results("SELECT COUNT(*) as pm_rowcount FROM ".$table_prefix."evntgen_ustsevents_paymentmethods");
   if(!$pm_count[0]->pm_rowcount){
      $sql_pm_data = "INSERT INTO `".$table_prefix."evntgen_ustsevents_paymentmethods` (`id`,`payment_method`) VALUES (2,'Bank'),(3,'Cash'),(4,'Paypal'),(5,'Credit Card'),(6,'Other');";
      $wpdb->query($sql_pm_data);
   }
   
   $table_sponsors = $table_prefix.'evntgen_sponsors';
   $sql_sponsors = "CREATE TABLE IF NOT EXISTS $table_sponsors(
                    `id` int(11) NOT NULL AUTO_INCREMENT,
                    `sponsor_name` varchar(256) DEFAULT NULL,
   ...
   $wpdb->query($sql_sponsors);
   
   $table_organizer = $table_prefix.'evntgen_organizers';
   $sql_organizer = "CREATE TABLE IF NOT EXISTS $table_organizer (
                        `id` int(11) NOT NULL AUTO_INCREMENT,
   ...
   $wpdb->query($sql_organizer);
   
   $table_venues = $table_prefix.'evntgen_venues';
   ...
   $wpdb->query($sql_venues);
	 //===============================Currency Table==================================
	 $table_currency = $wpdb->prefix ."evntgen_currency_list";
  ...
  if(!$curr_count[0]->rowcount){
    ...
    $wpdb->query($currency_tbl_data);
	 ...
	 //===============================End Currency Table==============================
	 $scevent_calendar_page_id = evntgen_programmatically_create_page('Event Calendar','usts-event-calendar','[evntgen_ustscalendar]','page');
	 //$cart_page_id = evntgen_programmatically_create_page('Shopping Cart','shopping-cart','[evntgen_scevent_shoppingcart]','page');
	 //$checkout_page_id = evntgen_programmatically_create_page('Checkout','checkout','[evntgen_scevent_checkout]','page');
	 //$order_success_id = evntgen_programmatically_create_page('Order Success','order-success','[evntgen_scevent_ordersuccess]','page');
